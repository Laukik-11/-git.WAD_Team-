...
class VisitorAdmin(admin.ModelAdmin):
    # Available Fields in the admin panel for the model
    list_display = ['name', 'purpose', 'number']
    readonly_fields = ['entryTime', 'flat']

# Registering the custom Resident Admin
...
class ResidentAdmin(UserAdmin):
    ...
    # Inlines to directly access the Vehicle , Complaints and Visitors related to a Resident
